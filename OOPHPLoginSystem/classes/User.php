	...
	class User {
		...
		public function update($fields = array(), $id = null) {
			...
			if (!$this->_db->update('users', $id, $fields)) {
                ...
                /**
                 * thêm user
                 * @param type $fields các thông tin user
                 * @throws Exception
                 */
		public function create($fields = array()) {
			if (!$this->_db->insert('users', $fields)) {
                ...
                /**
                 * tìm ki?m 1 user theo id ho?c username
                 * @param type $user tên user c?n tìm
                 * @return boolean
                 */
		public function find($user = null) {
			...
			return false;
                ...
                /**
                 * ki?m tra ??ng nh?p
                 * @param type $username tên ??ng nh?p
		...
		public function login($username = null, $password = null, $remember = false) {
			...
			return false;
                ...
                /**
                 * ki?m tra quy?n
                 * @param type $key l?u quy?n ng??i dùng
                 * @return boolean
                 */
